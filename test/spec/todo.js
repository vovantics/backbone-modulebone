define(['modules/todo'], function(Todo) {
  ...
  describe('Todo Module', function() {
    ...
    before(function(done) {
      ...
      form = new Todo.Views.Form({collection: todos});
      toggle = new Todo.Views.ToggleAll({collection: todos});
      list = new Todo.Views.List({collection: todos});
      stats = new Todo.Views.Stats({collection: todos});
